...
const PasswordCriteria = ({ password }) => {
    ...
    const criteria = [
        ...
        { lable: "contains special character", met: /[^A-Za-z0-9]/.test(password) },
    ...
    return (
        <div className="mt-2 space-y-1">
            {criteria.map((item) => (
                <div key={item.lable} className="flex items-center text-xs">
                    {item.met ? (
